...
min_v_x = parameters[7]
max_v_x = parameters[8]
...
def animate(i):
    ...
    cont = plt.contourf(x, y, u, linspace(min_v_x, max_v_x, 250), cmap='viridis') 
    cbar = plt.colorbar(cont)
    #quiv = plt.quiver(x, y, u, v, pivot='mid', angles='xy', width=0.0005, color='w') 
